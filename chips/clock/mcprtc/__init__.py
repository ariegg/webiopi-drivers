...
#   1.3    2016-08-17    Added @api annotations.
#   1.4    2016-08-29    Added setDateTimeString including REST mapping
#
#   Usage remarks
#
...
#     simplification.
#   - Setting datetime via REST is handled the same way for consistency and 
#     simplification.
#
...
#---------- Clock abstraction REST implementation ----------
    ...
    @api("Clock")
    @request("POST", "clock/datetime/%(value)s")
    @response("%s")
    def setDateTimeString(self, value):
        year, month, day, hour, minute, second = self.String2DateTimeValues(value)
...
#---------- Clock values formatting ----------
    ...
    def String2DateTimeValues(self, string):
        dateString, timeString = string.split('T')
        year, month, day = self.String2DateValues(dateString)
        hour, minute, second = self.String2TimeValues(timeString)
