...
#   1.1    2016-08-26    Added support for bus selection. Deleted banks
#                        parameter for GPIOPort __init__() call.
#
#   Config parameters
#
...
#---------- Class initialisation ----------
    ...
    def __init__(self, slave=0x60, prescale0=0, prescale1=0, ledmode=0b1110, bus=None):
        ...
        GPIOPort.__init__(self, self.GPIO_CHANNELS)
...
#---------- Abstraction framework contracts ----------
    ...
    def __str__(self):
        return "PCA9530(slave=0x%02X, dev=%s)" % (self.slave, self.device())
